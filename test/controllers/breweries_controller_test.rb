...
class BreweriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post breweries_url, params: { brewery: { brewerydbid: @brewery.brewerydbid, name: @brewery.name } }, as: :json
    end
  ...
  test "should update brewery" do
    patch brewery_url(@brewery), params: { brewery: { brewerydbid: @brewery.brewerydbid, name: @brewery.name } }, as: :json
    assert_response 200
  end
